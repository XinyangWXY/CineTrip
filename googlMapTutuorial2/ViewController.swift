...
class ViewController: UIViewController, CLLocationManagerDelegate, GMSMapViewDelegate, GMSAutocompleteViewControllerDelegate, UITextFieldDelegate {
    ...
    let previewDemoData = [(title: "Wing Shun St", img: #imageLiteral(resourceName: "pic3"), price: 10), (title: "Hong Kong 2", img: #imageLiteral(resourceName: "pic2"), price: 8), (title: "Hong Kong 3", img: #imageLiteral(resourceName: "pic1"), price: 12),(title:"pic 4", img:#imageLiteral(resourceName: "pic4.jpeg"), price:4),(title:"pic 5", img:#imageLiteral(resourceName: "pic5.png"), price:5),(title:"image 7", img:#imageLiteral(resourceName: "image7.png"), price:7),(title:"image 9", img:#imageLiteral(resourceName: "image9.png"), price:9)]
